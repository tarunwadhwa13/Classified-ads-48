...
Validator.prototype = {
    value: true,
    isNotEmpty: function(orr) {
        this.value = orr ? assign(or, this, this.text.length > 0)
            : assign(and, this, this.text.length > 0)
        return this;
    },
    isLongerThan: function(len, orr) {
        this.value = orr ? assign(or, this, this.text.length > len)
            : assign(and, this, this.text.length > len)
        return this;
    },
    evaluate: function() {
        return this.value;
...
// console.log(new Validator('Ad').isLongerThan(2, false).evaluate());
console.log(new Validator('Bob').isNotEmpty().isLongerThan(3, false).evaluate());
console.log(new Validator('Bob').isNotEmpty().isLongerThan(3, true).evaluate());